...
<template>
  <header
    ...
    <div class="flex gap-md items-center">
      <button class="p-2 rounded-full hover:bg-surface-container-low transition-colors active:scale-95 duration-100 cursor-pointer" @click="onToggleTheme" aria-label="Cambiar tema">
        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24;">dark_mode</span>
      </button>
    </div>
  </header>
</template>
